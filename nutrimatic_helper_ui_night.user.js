    ...
    style.textContent = `
        ...
        * {
        ...
        body {
            ...
            background: linear-gradient(135deg, #0f1419 0%, #1a1f24 50%, #141b22 100%);
        ...
        body::before {
            ...
            width: 200%;
            height: 200%;
            background: radial-gradient(circle 900px at 30% 20%, rgba(90, 159, 212, 0.2) 0%, transparent 50%),
                        radial-gradient(circle 1600px at 70% 60%, rgba(160, 255, 250, 0.1) 0%, transparent 50%);
            pointer-events: none;
            z-index: 0;
        }
        ...
        .search-wrapper:focus-within {
            ...
            box-shadow: 0 4px 24px rgba(90, 159, 212, 0.2),
        ...
        .search-button {
            ...
            width: 40px;
            height: 40px;
            background: linear-gradient(135deg, rgba(90, 159, 212, 0.2), rgba(85, 238, 160, 0.2));
            border: none;
            border-radius: 50%;
            cursor: pointer;
            display: flex;
        ...
        .search-button:hover {
            background: linear-gradient(135deg, rgba(90, 159, 212, 0.4), rgba(85, 238, 160, 0.3));
        ...
        ::-webkit-scrollbar-thumb {
            background: linear-gradient(180deg, #557080, #778880);
            border-radius: 5px;
        }

        ::-webkit-scrollbar-thumb:hover {
            background: linear-gradient(180deg, #778899, #669999);
        }
    `;
